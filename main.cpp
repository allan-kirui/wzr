...
void VirtualWorldCycle()
{
	...
	{                              // nale¿y na nowo obliczyæ œredni czas cyklu avg_cycle_time
		...
		sprintf(text, "WZR-lab lato 2021/22 temat 1, wersja b (%0.0f fps  %0.2fms) ", fFps, 1000.0 / fFps);
	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR-lab lato 2022/23 temat 1 - wersja b", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
